module.exports = {
  // Domain
  DOMAIN: 'jolly-game.com',

  // Paths
  HOME_PATH: '/',
  SPYFALL_RULES: '/spyfallrules',

  // Teams Deep Links
  BOT_URL:
    'https://teams.microsoft.com/l/chat/0/0?users=28:a108d78b-8d6e-4672-8449-bd9f1064a577',
  ...
  HOST_START_UPDATABLE: 'HOST_START_UPDATABLE',
  POLL_UPDATABLE: 'poll',
